...
export function generateVariables() {
	return {
		...
		color: {
			appTheme: getComputedStyle(document.body).getPropertyValue('--bs-app-theme').trim(),
			appThemeRgb: getComputedStyle(document.body).getPropertyValue('--bs-app-theme-rgb').trim(),
			appThemeColor: getComputedStyle(document.body).getPropertyValue('--bs-app-theme-color').trim(),
			appThemeColorRgb: getComputedStyle(document.body).getPropertyValue('--bs-app-theme-color-rgb').trim(),
			...
			omponentColor: (getComputedStyle(document.body).getPropertyValue('--bs-component-color')).trim(),
